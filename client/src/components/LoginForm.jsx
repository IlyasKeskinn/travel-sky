...
const LoginForm = () => {
    ...
    return (
        <div className="relative bg-white rounded-3xl shadow-lg w-full max-w-4xl overflow-hidden h-[575px]">
            ...
            <div className={`absolute inset-0 flex flex-col lg:flex-row transform transition-transform duration-700 ${isSignUp ? '-translate-x-full' : ''}`}>
                ...
                <SignIn />
                {/* Sign Up Side */}
                <div className="w-full lg:w-1/2 bg-gradient-to-r from-teal-500 to-green-500 text-white p-10 flex flex-col justify-center items-center">
            ...
            <div className={`absolute inset-0 flex flex-col lg:flex-row transform transition-transform duration-700 ${!isSignUp ? 'translate-x-full' : ''}`}>
                ...
                <div className="w-full lg:w-1/2 bg-gradient-to-r from-teal-500 to-green-500 text-white p-10 flex flex-col justify-center items-center">
                    ...
                    <button onClick={toggleMode} className="mt-10 py-2 px-10 bg-white text-green-500 rounded-lg hover:bg-gray-200 transition">Sign In</button>
                    <Link className='mt-2' to={ROUTES.HOME}>Go Home</Link>
                </div>
            </div>
        </div>
